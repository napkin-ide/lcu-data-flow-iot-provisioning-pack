import { LCUChart } from './../../../../../common/src/lib/models/chart';
import { InfrastructureModel } from './../../../../../common/src/lib/models/infrastructure.model';
...
export class WarmStorageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //   Infrastructure: {
    //     Connections: {          'Primary SQL Connection String': 'AccountEndpoint=https://lcu-int.documents.azure.com:443/;AccountKey=Qan4GIhRTovYZmdogrsZnYDR8xiI0RL6gvGa9ufnp3c4RGRit0xAmasqiEOEwqPQs3HoN60w8NyM5E6DbW96yA==;',
